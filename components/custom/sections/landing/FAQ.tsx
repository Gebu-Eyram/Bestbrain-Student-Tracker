...
const FAQ = () => {
  return (
    <Accordion
      className="flex w-full flex-col divide-y max-w-2xl mx-auto p-2 py-8  sm:py-16 sm:px-8  divide-border dark dark:divide-zinc-700"
    ...
    >
      <AccordionItem value="getting-started" className="py-2">
        ...
        <AccordionContent>
          <p className="text-zinc-2000 dark:text-zinc-400">
