import BlurryBlob from "@/components/animata/backgrounds/bg";
...
const ContentSection = () => {
  return (
    <div className="bg-black px-6 relative  md:px-12 xl:px-16">
      <div className="py-16 px-4 sm:px-8  bg-transparent/5 backdrop-blur-lg overflow-hidden dark  rounded-3xl">
        ...
        />
        <div className="xl:container relative z-50 m-auto ">
