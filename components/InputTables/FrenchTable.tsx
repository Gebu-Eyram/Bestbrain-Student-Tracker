...
const FrenchTable = ({ school_id, exams_id }: SchoolProps) => {
            ...
            <div>
              ...
              >
                ...
                <Input
                  ...
                  min={0}
                  type="number"
                  defaultValue={student.french_A}
                  {...register(`students.${student.student_id}.french_A`)}
                />
                <Input
                  type="number"
                  max={100}
                  min={0}
                  defaultValue={student.french_B}
                  {...register(`students.${student.student_id}.french_B`)}
                />
                <Button
