...
const RMETable = ({ school_id, exams_id }: SchoolProps) => {
            ...
            <div>
              ...
              >
                ...
                <Input
                  ...
                  min={0}
                  type="number"
                  defaultValue={student.rme_A}
                  {...register(`students.${student.student_id}.rme_A`)}
                />
                <Input
                  type="number"
                  max={100}
                  min={0}
                  defaultValue={student.rme_B}
                  {...register(`students.${student.student_id}.rme_B`)}
                />
                <Button
