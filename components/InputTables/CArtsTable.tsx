...
const CArtsTable = ({ school_id, exams_id }: SchoolProps) => {
            ...
            <div>
              ...
              >
                ...
                <Input
                  ...
                  min={0}
                  type="number"
                  defaultValue={student.c_arts_A}
                  {...register(`students.${student.student_id}.c_arts_A`)}
                />
                <Input
                  type="number"
                  max={100}
                  min={0}
                  defaultValue={student.c_arts_B}
                  {...register(`students.${student.student_id}.c_arts_B`)}
                />
                <Button
